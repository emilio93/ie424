...
INICIO:
 ...
 // posición del jugador
  ...
  // posición del obstaculo1
  STO, R24, 20'd35 // horizontal
  STO, R25, 20'd20 // vertical
	
	// posición del obstaculo2
  STO, R22, 20'd35 // horizontal
  STO, R23, 20'd27 // vertical
...
DELAY_MAIN1:
	...
	STO, R4, 20'd0
	DONT_OBST1:
		BLE, DONT_OBST_2, R6, R7
		CALL, MOVIMIENTO_OBST2, 20'b0
		STO, R6, 20'd0
		DONT_OBST_2:
		NOP, 30'b0
		ADD, R6, R6, R1
	ADD, R4, R4, R1
	CALL, CHEQUEAR_DERROTA, 20'b0
